...
#ifndef CS106B_RANDOM_H
#define CS106B_RANDOM_H
 ...
 * ----------------------------------------
 * Returns a random real number in the half-open interval [low .. high). A half-open
 * interval includes the first endpoint but not the second, which means that the
 * result is always greater than or equal to low but strictly less than high.
 */
 ...
 * calling randomChance(.30) returns ture 30 percent of the time.
 */
