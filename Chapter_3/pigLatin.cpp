 ...
 * 2. If the word begins with a consonant, extract the set of consonants up to the first vowel,
 * move that set of consonants to the end of the word, and add "ay" to the end.
 ...
 * the code sets start to -1 to indicate that the beginning of the current
 ...
 *  ----------------------------------------
 *  Returns the index position of the first vowel in the word. If
 *  word does not contain any vowels, findFirstVowel returns -1.
 */
